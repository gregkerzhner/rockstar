angular.module('rockstar.common.directives.3dplot', []).directive('3dplot', function () {
  return {
    restrict: 'A',
  ...
  function ($scope, $element) {
    ...
    scene.add(new THREE.AmbientLight(15658734));
    ...
    $scope.draw = function () {
      ...
      for (var i = 0; i < coordinates.length; i++) {
        ...
        coord = $scope.translate(projection([
    ...
    $scope.translate = function (point) {
      return point;  //return [point[0] - (terrainSize / 2), (terrainSize / 2) - point[1]];
    };
